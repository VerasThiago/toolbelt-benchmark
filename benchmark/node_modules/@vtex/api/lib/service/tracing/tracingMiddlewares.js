    ...
    return async function addTracing(ctx, next) {
        ...
        const currentSpan = tracer.startSpan('unknown-operation', {
            ...
            tags: {
                ...
                [Tags_1.Tags.HTTP_URL]: ctx.request.href,
        ...
        try {
            ...
            spanSetup_1.injectErrorOnSpan(currentSpan, err, (_a = ctx.vtex) === null || _a === void 0 ? void 0 : _a.logger);
            throw err;
        }
        finally {
...
exports.traceUserLandRemainingPipelineMiddleware = (spanName, tags = {}) => {
    return async function traceUserLandRemainingPipeline(ctx, next) {
        ...
        try {
            ...
            spanSetup_1.injectErrorOnSpan(span, err, ctx.vtex.logger);
            throw err;
        }
        finally {
