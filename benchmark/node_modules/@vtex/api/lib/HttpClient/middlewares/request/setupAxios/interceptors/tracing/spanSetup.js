...
const LogFields_1 = require("../../../../../../tracing/LogFields");
...
exports.injectRequestInfoOnSpan = (span, http, config) => {
    ...
    span.log({ [LogFields_1.LOG_FIELDS.EVENT]: 'request-headers', headers: config.headers });
};
...
exports.injectResponseInfoOnSpan = (span, response) => {
    ...
    span.log({ [LogFields_1.LOG_FIELDS.EVENT]: 'response-headers', headers: response.headers });
