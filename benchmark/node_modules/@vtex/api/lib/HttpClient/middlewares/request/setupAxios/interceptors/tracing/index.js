...
const preRequestInterceptor = (http) => (config) => {
    ...
    const { tracer, rootSpan, requestSpanNameSuffix, referenceType = SpanReferenceTypes_1.SpanReferenceTypes.CHILD_OF, } = config.tracing;
...
const onResponseError = (err) => {
    ...
    spanSetup_1.injectErrorOnSpan(requestSpan, err, err.config.tracing.logger);
    requestSpan.finish();
    return Promise.reject(err);
};
